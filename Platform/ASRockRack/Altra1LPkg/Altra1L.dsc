...
[Defines]
  ...
  FLASH_DEFINITION               = Platform/ASRockRack/Altra1LPkg/Altra1L.fdf
...
!endif
  ...
  DEFINE PLATFORM_CONFIG_UUID    = e34437ca-d7f1-4b9d-ab61-5258f69b8d61
...
!if $(UEFI_SECURE_BOOT_ENABLE) == TRUE
  ...
  !include Platform/ASRockRack/Altra1LPkg/root.cer.gEfiSecurityPkgTokenSpaceGuid.PcdPkcs7CertBuffer.inc
!endif
...
[PcdsDynamicExDefault.common.DEFAULT]
  ...
  gEfiMdeModulePkgTokenSpaceGuid.PcdSystemFmpCapsuleImageTypeIdGuid|{GUID("b7704e65-f15e-4299-b8e8-6fee164b8ff9")}|VOID*|0x10
  gEfiSignedCapsulePkgTokenSpaceGuid.PcdEdkiiSystemFirmwareFileGuid|{GUID("7cb80256-1412-462e-b83c-449eaba96dad")}|VOID*|0x10
...
!endif
  ...
  #
!if $(CAPSULE_ENABLE) == TRUE
  Platform/ASRockRack/Altra1LPkg/Capsule/SystemFirmwareDescriptor/SystemFirmwareDescriptor.inf
